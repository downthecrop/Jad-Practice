...
public class VolcanicAbyssalWhip extends ItemCombination {

	public VolcanicAbyssalWhip(GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created a volcanic abyssal whip.", outcome.getId());
