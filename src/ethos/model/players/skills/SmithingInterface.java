...
public class SmithingInterface {
	...
	private void makeRuneInterface(Player c) {
		...
		c.getPA().sendFrame126(GetForlvl(91, c) + "Heads" + GetForlvl(4, c), 13358);
	...
	private void makeAddyInterface(Player c) {
		...
		c.getPA().sendFrame126(GetForlvl(76, c) + "Heads" + GetForlvl(4, c), 13358);
	...
	private void makeMithInterface(Player c) {
		...
		c.getPA().sendFrame126(GetForlvl(56, c) + "Heads" + GetForlvl(4, c), 13358);
	...
	private void makeSteelInterface(Player c) {
		...
		c.getPA().sendFrame126(twob + "2 Bars" + twob, 1114);
		c.getPA().sendFrame126(twob + "2 Bars" + twob, 1089);
		c.getPA().sendFrame126(oneb + "1 Bar" + oneb, 8428);
		c.getPA().sendFrame126(oneb + "1 Bar" + oneb, 1124);
		c.getPA().sendFrame126(oneb + "1 Bar" + oneb, 1125);
		c.getPA().sendFrame126(oneb + "1 Bar" + oneb, 1126);
		c.getPA().sendFrame126(oneb + "1 Bar" + oneb, 1127);
		...
		c.getPA().sendFrame126(GetForlvl(36, c) + "Limbs" + GetForlvl(36, c), 11461);
		...
		c.getPA().sendFrame126(GetForlvl(34, c) + "Sword" + GetForlvl(34, c), 1085);
		c.getPA().sendFrame126(GetForlvl(34, c) + "Dart Tips" + GetForlvl(34, c), 8429);
		c.getPA().sendFrame126(GetForlvl(34, c) + "Bolts" + GetForlvl(34, c), 1107);
		c.getPA().sendFrame126(GetForlvl(36, c) + "Heads" + GetForlvl(4, c), 13358);
	...
	private void makeIronInterface(Player c) {
		...
		c.getPA().sendFrame126(GetForlvl(28, c) + "Claws" + GetForlvl(28, c), 8429);
		...
		c.getPA().sendFrame126(GetForlvl(23, c) + "Limbs" + GetForlvl(23, c), 1134);
		...
		c.getPA().sendFrame126(GetForlvl(19, c) + "Dart Tips" + GetForlvl(19, c), 1096);
		c.getPA().sendFrame126(GetForlvl(21, c) + "Heads" + GetForlvl(19, c), 13358);
		c.getPA().sendFrame126(GetForlvl(18, c) + "Medium Helm" + GetForlvl(18, c), 1102);
	...
	private void makeBronzeInterface(Player c) {
		...
		c.getPA().sendFrame126(GetForlvl(13, c) + "Claws" + GetForlvl(13, c), 8429);
		...
		c.getPA().sendFrame126(GetForlvl(6, c) + "Limbs" + GetForlvl(6, c), 11461);
		...
		c.getPA().sendFrame126(GetForlvl(4, c) + "Bolts (unf)" + GetForlvl(4, c), 1107);
		c.getPA().sendFrame126(GetForlvl(4, c) + "Dart Tips" + GetForlvl(4, c), 1096);
		c.getPA().sendFrame126(GetForlvl(6, c) + "Heads" + GetForlvl(4, c), 13358);
