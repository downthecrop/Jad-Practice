...
public class Lowpkarena {
     ...
     */
    private static int lowGameStartTimer = 600;
    /**
    ...
    public static boolean updateWaitingRoom(Player c) {
        c.getPA().sendFrame126("Next Game Begins In : " + lowGameStartTimer, 2805);
    ...
    public static void process() {
        ...
        if (!gameStarted) {
            ...
            } else if (lowGameStartTimer == 0) {
                if (getListCount(WAITING) != 1) {
                    beginGame();
                }
                //lowGameStartTimer = 80;
            }
        }
