	...
	public int[] method167(int i, int j) {
		...
		for (int k2 = 0; k2 < i; k2++) {
			...
			if (aClass29_102 != null) {
				...
				j4 = j4
						* ((method168(k6, i2, aClass29_102.anInt540) >> 1) + 32768) >> 15;
				i2 += (k5 * k1 >> 16) + l1;
			}
			for (int l5 = 0; l5 < 5; l5++)
				if (anIntArray106[l5] != 0) {
					...
					if (l6 < i) {
						anIntArray115[l6] += method168(
								j4 * anIntArray120[l5] >> 15,
								anIntArray118[l5], aClass29_98.anInt540);
		...
		if (aClass39_111.anIntArray665[0] > 0
			...
			if (i >= i5 + i6) {
				...
				if (l7 > i - i5)
					l7 = i - i5;
				for (; j7 < l7; j7++) {
					int j8 = (int) ((long) anIntArray115[j7 + i5]
							* (long) Class39.anInt672 >> 16);
					for (int k8 = 0; k8 < i5; k8++)
						j8 += (int) ((long) anIntArray115[(j7 + i5) - 1 - k8]
								* (long) Class39.anIntArrayArray670[0][k8] >> 16);

					for (int j9 = 0; j9 < j7; j9++)
						j8 -= (int) ((long) anIntArray115[j7 - 1 - j9]
								* (long) Class39.anIntArrayArray670[1][j9] >> 16);
				...
				do {
					if (l7 > i - i5)
						l7 = i - i5;
					for (; j7 < l7; j7++) {
						int l8 = (int) ((long) anIntArray115[j7 + i5]
								* (long) Class39.anInt672 >> 16);
						for (int k9 = 0; k9 < i5; k9++)
							l8 += (int) ((long) anIntArray115[(j7 + i5) - 1
									- k9]
									* (long) Class39.anIntArrayArray670[0][k9] >> 16);

						for (int i10 = 0; i10 < i6; i10++)
							l8 -= (int) ((long) anIntArray115[j7 - 1 - i10]
									* (long) Class39.anIntArrayArray670[1][i10] >> 16);
				...
				for (; j7 < i; j7++) {
					...
					for (int l9 = (j7 + i5) - i; l9 < i5; l9++)
						i9 += (int) ((long) anIntArray115[(j7 + i5) - 1 - l9]
								* (long) Class39.anIntArrayArray670[0][l9] >> 16);

					for (int j10 = 0; j10 < i6; j10++)
						i9 -= (int) ((long) anIntArray115[j7 - 1 - j10]
								* (long) Class39.anIntArrayArray670[1][j10] >> 16);
